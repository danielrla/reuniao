...
export declare const createMeeting: (req: Request, res: Response, next: NextFunction) => Promise<any>;
export declare const updateMeeting: (req: Request, res: Response, next: NextFunction) => Promise<any>;
